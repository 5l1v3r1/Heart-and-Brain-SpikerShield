//
// Heart and Brain SpikerShield based P300 experiment 
// Heart and Brain version 2.0 based on ATMEGA 328 (UNO)
// 
// V1.0
// Backyard Brains
// Stanislav Mircic
...
//
// D9 - Speaker output
// D4 - Aux. button input (generates Event 3 on rising edge)
//
// 20. Nov. 2019
//
...
void setup(){ 
  ...
  //Inputs for events 
  pinMode(SPEAKER_OUTPUT, OUTPUT); //PB1
  pinMode(EVENT_INPUT_3, INPUT);   //PB3
